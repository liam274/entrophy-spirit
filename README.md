...
We have figured out that, surprisingly, its analysis result given is very similar to humans' EEG in the specific occasion!(In the old version, v0.0.1. The current version will not output the correct EEG)
